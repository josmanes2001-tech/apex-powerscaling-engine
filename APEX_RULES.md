...
## 3. Comandos de Verificación & Despliegue
...
- **Despliegue a Vercel**: `npm run deploy` o `node src/scripts/autoDeployVercel.js`
- **Sincronización en Vivo**: `npm run watch:deploy` o `node src/scripts/watchAndSync.js`