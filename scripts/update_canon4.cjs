...
- Identifica si posee Sub-Entidades (Stands, Simbiontes, Invocaciones ligadas) o Armamento clave.
- Asigna los Hax Tags relevantes (ej: ["Negación de Durabilidad", "Manipulación Espacial"]).

Debes devolver ÚNICAMENTE un objeto JSON válido (sin markdown) con la siguiente estructura exacta:
{
  "id": "nombre-slug",
  "name": "\${name}",
  ...
  "range": "Rango de ataque efectivo (ej: Cuerpo a cuerpo estándar, Cientos de metros, Planetario)",
  "speed": {
  ...
  "haxTags": ["Tag 1", "Tag 2"],
  "subEntity": {
    "name": "Nombre Stand / Simbionte / Invocación principal (o dejar vacío si no aplica)",
    "type": "Stand / Invocación / Simbionte",
    "stats": "Poder y reglas de daño compartido"
  },
  "abilities": [
  ...
  console.log('Prompt successfully updated with Range, HaxTags, and SubEntity support.');
} else {
