...
- Eres estricto con el canon. NO inventes transformaciones, poderes ni estados que el personaje nunca alcanzó oficialmente.
- Por ejemplo, Gohan NO tiene Super Saiyan Blue; Naruto NO tiene Bankai. Limítate a sus formas reales y confirmadas.
...
Debes devolver ÚNICAMENTE un objeto JSON válido (sin markdown) con la siguiente estructura exacta de 12+ campos:
{
  ...
  "forms": [
    ...
    { "id": "canon-1", "name": "Nombre de Transformación CANÓNICA", "stats": "Multiplicadores y desgaste de estamina" }
  ],
  ...
  console.log('Prompt successfully updated with STRICT CANON RULES.');
} else {
